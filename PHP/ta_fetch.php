...
$sql = "SELECT assignment, mark, firstname, lastname, g.student_id FROM grades AS g INNER JOIN student AS s ON g.student_id = s.student_id WHERE g.ta_id = $ta_id";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // output data of each row

    echo "<table id='ta_table'>";
